...
| <a name="input_image_tags"></a> [image\_tags](#input\_image\_tags) | A map representing the ACR image tags to use for each integration. | `map(string)` | <pre>{<br/>  "dbt_core": "2026.09.04-1",<br/>  "python": "2026.09.04-1"<br/>}</pre> | no |
