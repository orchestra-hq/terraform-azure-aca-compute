...
| <a name="input_app_registration_object_id"></a> [app\_registration\_object\_id](#input\_app\_registration\_object\_id) | Only set this if you do not have permissions to configure the App Registration and Enterprise App via Terraform. If set, ensure that the Enterprise Application has been set up as documented in https://docs.getorchestra.io/docs/deployment-options/hybrid/aca_jobs. | `string` | `""` | no |
