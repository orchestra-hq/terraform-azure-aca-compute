...
| <a name="input_image_tags"></a> [image\_tags](#input\_image\_tags) | A map representing the ACR image tags to use for each integration. | `map(string)` | <pre>{<br/>  "dbt_core": "2026.04.27-0",<br/>  "python": "2026.04.21-1"<br/>}</pre> | no |
